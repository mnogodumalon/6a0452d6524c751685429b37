...
const PROXY_BASE = '';
const APP_ID = '6a0452c3153123bae8fd8592';
...
export default function PublicFormVerknuepfungen() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Verknüpfungen — Formular</h1>
        </div>
